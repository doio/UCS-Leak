        ...
        public void StartServer()
        {
            try
            {
                ...
                using (Socket listener = new Socket(AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.Tcp))
                {
                    ...
                    Console.WriteLine("[PROXY]    Started Listener on " + port + " in " + UCP.Proxy._Stopwatch.ElapsedMilliseconds + " Milliseconds!");
                    UCP.Proxy._Stopwatch.Stop();
            ...
            {
                Console.WriteLine("[UCP]    {0}", e.Message);
            }

            Console.WriteLine("\n[UCP]      Press ENTER to continue...");
            Console.Read();
        }
    }
}